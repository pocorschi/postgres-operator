...
[minimal example](https://github.com/pocorschi/postgres-operator/blob/master/manifests/minimal-postgres-manifest.yaml):
...
[minimal postgres manifest](https://github.com/pocorschi/postgres-operator/blob/master/manifests/minimal-postgres-manifest.yaml)
...
See [infrastructure roles secret](https://github.com/pocorschi/postgres-operator/blob/master/manifests/infrastructure-roles.yaml)
and [infrastructure roles configmap](https://github.com/pocorschi/postgres-operator/blob/master/manifests/infrastructure-roles-configmap.yaml) for the examples.
