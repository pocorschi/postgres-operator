...
`github.com/pocorschi/postgres-operator` should be put at
-`~/go/src/github.com/pocorschi/postgres-operator`.
...
* [Relevant pull request](https://github.com/pocorschi/postgres-operator/pull/369)
